// Be a Brit
var colurs = {
    colurnames: ["Peru", "Orange", "Salmon", "CadetBlue", "Olive", "Chocolate", "DodgerBlue", "BurlyWood", "Chartreuse", "Tomato", "SteelBlue", "FireBrick", "ForestGreen"],
    colurphrase1: ["Don't you think it is strange that I'm not the same colour as the Peruvian Flag?", "Do you want to hear a joke?", "Are you a bear?", "Have you ever gone to space?", "Do you like Italy?", "Are you from Switzerland?", "Are you a Giants fan?", "Did you watch Superbowl 53?", "Do ya need anything from me?", "Care to have a drink?", "Are you a European?", "Have you ever been to Detroit?", "Do ya think you could take me?", "Have you donated to my save the forests charity?"],
    colourphraseError: ["Please select one"],
    colurphrase2a: ["I've started a petition targeted at the owner of the Internet.", "Then orange you glad I already have some jokes lined up!", "Please don't eat me!", "I wanna go there too when I grow up!", "Same! I do BECAUSE PIZZA.", "I'm from there, too.", "Dodgers are better, you Giant.", "*Grunts*", "Let me get that for you. Today's special is especially aromatic.", "Some of your kind used to think me poisonous.", "Did you see South Detroit? It's my hometown.", "Let me teach you a lesson about my birthplace: the firey pits of the underowrld.", "Thank you for your service, strange mammalian creature."],
    colurphrase2b: ["To each their own, I suppose.", "Orange you glad I haven't already began a joke?", "Thank the fish gods.", "I wanna go to space when I grow up!", "But what about PIZZA?", "I'm 65% cacao, by the way.", "Go Dodgers!", "Then leave.", "That's okay. We have specialty preztels, too.", "I am tasty in a salad.", "You should go, it's my favorite city.", "Then begone!", "Just sign here and I'll get you started." ]
};
var colurcycle = 0;
//Click!
console.log("step0");
